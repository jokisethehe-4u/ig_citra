...
const accounts = {
    'citraa__': {
        ...
        dms: [
            { user: 'putri.ayuu', img: 'assets/teman1.png', msg: 'Foto yang tadi bagus!', time: '2h', note: 'Ready for whattt ...' },
            ...
            { user: 'nisa.imut', img: 'assets/teman4.png', msg: 'Sent a reel by pwetianaaa_', time: '7h', note: 'hmmm' },
        ...
        posts: [
            ...
            },
            {
                ...
                time: '2 HOURS AGO',
                slides: [{ img: 'assets/teman1.png', elements: [] }]
            },
            {
                id: 'p2',
                ...
                time: '5 HOURS AGO',
                slides: [{ img: 'assets/teman2.png', elements: [] }]
            }
        ],
        highlights: [
    ...
    'icitttt': {
        ...
        dms: [
            { user: 'putri.ayuu', img: 'assets/teman1.png', msg: 'cit, besok jadi jalan?', time: '1h', note: 'lagi pengen seblak' },
            { user: 'salsabila_99', img: 'assets/teman2.png', msg: 'Lucu bgt fotonyaaa', time: '2h', isUnread: true, note: 'Tidur woy kaliannnn' },
        ...
        posts: Array.from({length: 7}, (_, i) => ({
            ...
            caption: `Vibes ${i+1} ✨`,
            time: `${i+2} HOURS AGO`,
            slides: [{ img: `assets/second/foto${(i % 8) + 4}.jpeg`, elements: [] }]
        })),
        highlights: []
    }
};
...
function setupEventListeners() {
    ...
    if (loginSwitchBtn) {
        loginSwitchBtn.addEventListener('click', () => {
            state.currentAccount = state.currentAccount === 'citraa__' ? 'icitttt' : 'citraa__';
...
function renderFeed() {
    ...
    allPosts.forEach((post, postIndex) => {
        ...
        postEl.innerHTML = `
            ...
            <div class="post-likes-row">Liked by pwetianaa__ and others</div>
